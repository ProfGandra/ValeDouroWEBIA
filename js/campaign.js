...
const originalStart=window.startAdventure;if(typeof originalStart==='function')window.startAdventure=async function(){await loadCurrent();return originalStart.apply(this,arguments)};
const originalResume=window.resumeGame;if(typeof originalResume==='function')window.resumeGame=async function(){await loadCurrent();return originalResume.apply(this,arguments)};
})();