...
const MENU_ART='assets/valedouro-menu-oficial.webp?v=20260912-14';
...
function ensureStyles(){
  ...
  s.id='vd-howto-style';
  s.textContent=`
    /* Volta ao mesmo modelo da primeira versão: imagem e hotspots compartilham
       exatamente o mesmo palco proporcional. */
    ...
    /* Remove completamente o sistema SVG introduzido nos testes anteriores. */
    #opening .vd-menu-overlay{display:none!important;pointer-events:none!important}

    /* Hotspots HTML absolutos — mesma técnica usada originalmente no WEBIA. */
    #opening .hot{
      position:absolute!important;
      z-index:6!important;
      display:block!important;
    ...
    #opening .hot:hover,#opening .hot:focus{
      box-shadow:0 0 0 2px rgba(226,197,143,.70),0 0 26px rgba(211,173,104,.35)!important;
      background:rgba(211,173,104,.05)!important;
      outline:none!important;
    }

    /* Coordenadas da moldura externa dos cinco botões na arte oficial 1600x900. */
    #opening .h-history {left:4.25%!important;top:36.89%!important;width:27.50%!important;height:10.22%!important}
    #opening .h-universe{left:4.25%!important;top:48.44%!important;width:27.50%!important;height:10.22%!important}
    #opening .h-chars   {left:4.25%!important;top:60.00%!important;width:27.50%!important;height:10.22%!important}
    #opening .h-howto   {left:4.25%!important;top:71.44%!important;width:27.50%!important;height:10.22%!important}
    #opening .h-new     {left:4.25%!important;top:82.89%!important;width:27.50%!important;height:10.22%!important}
...
function ensureMenu(){
  ...
  const howTo=stage.querySelector('.h-howto');
  if(howTo && !howTo.dataset.vdBound){
    howTo.dataset.vdBound='1';
