...
const MENU_ART='assets/valedouro-menu-oficial.webp?v=20260912-19';
...
function ensureStyles(){
  ...
  s.textContent=`
    ...
    #opening .hot:hover,#opening .hot:focus{
      box-shadow:0 0 0 2px rgba(226,197,143,.95),0 0 26px rgba(211,173,104,.45)!important;
      background:rgba(211,173,104,.08)!important;
      outline:none!important;
    }

    /* Estado atual preservado para calibração individual. */
    #opening .h-history {left:4.25%!important;top:33.56%!important;width:27.50%!important;height:10.22%!important}
    #opening .h-universe{left:4.25%!important;top:45.11%!important;width:27.50%!important;height:10.22%!important}
    #opening .h-chars   {left:4.25%!important;top:56.67%!important;width:27.50%!important;height:10.22%!important}
    #opening .h-howto   {left:4.25%!important;top:68.11%!important;width:27.50%!important;height:10.22%!important}
    #opening .h-new     {left:4.25%!important;top:79.56%!important;width:27.50%!important;height:10.22%!important}

    /* Modo de calibração: mostra simultaneamente todas as áreas clicáveis. */
    #opening.vd-calibration .hot{
      outline:3px dashed rgba(255,220,120,.95)!important;
      outline-offset:-3px!important;
      background:rgba(255,220,120,.10)!important;
    }
    #opening.vd-calibration .hot::after{
